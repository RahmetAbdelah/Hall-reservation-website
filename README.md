...
Click Book This Room to submit a reservation
...
Students can track their requests under My Bookings, with statuses:
...
Reject the booking with a clear reason

Once approved:

The room becomes unavailable for the selected time
...
Local storage used to simulate a database

Real-time notifications for actions such as:
